...
handles.Range = 1;
handles.Tau = 10;
handles.El = -65 * ones(100, 100);          %resting potential
...
while get(hObject, 'Value')
      ...
      X = X - ((handles.dt/handles.Tau) .* ones(handles.M, handles.M)) .* ((X - handles.El) - RI_ext);   % if equation
...
%%
handles.M = round(get(hObject, 'Value'));
