...
% Last Modified by GUIDE v2.5 06-Feb-2012 10:15:47
...
handles.X = ones(handles.M, handles.M) .* (-65);
guidata(hObject, handles);
plot_grid(handles);
...
while 1
    ...
    if ~isempty(x)
        ...
        if (x>0)&&(x<handles.M+1)&&(y>0)&&(y<handles.M+1)
            ...
            handles.X = ((handles.vis_grid ~= 0) .* (-55)) + ...
                ((handles.vis_grid == 0) .* (-65));
            guidata(hObject, handles);
            plot_grid(handles);
        end
    else
...
elseif all(-56 <= handles.X < -55)
    colormap ([0.9 0.9 0]);
    
elseif all(-57 <= handles.X < -56)
    colormap ([0.8 0.8 0]);
    
elseif all(-58 <= handles.X < -57)
    colormap ([0.7 0.7 0])
    
elseif all(-59 <= handles.X < -58)
    colormap ([0.6 0.6 0])
    
elseif all(-60 <= handles.X < -59)
    colormap ([0.5 0.5 0])
    
elseif all(-61 <= handles.X < -60)
    colormap ([0.4 0.4 0])
    
elseif all(-62 <= handles.X < -61)
    colormap ([0.3 0.3 0])
    
elseif all(-63 <= handles.X < -62)
    colormap ([0.2 0.2 0])
    
elseif all(-64 <= handles.X < -63)
    colormap ([0.1 0.1 0 ])
    
elseif all(-65 <= handles.X < -64)
    colormap ([0 0 0])
